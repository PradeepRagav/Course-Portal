...
if($conn)
{
	...
	$sql1 = "SELECT topic FROM course_assignment WHERE course_id = '$cid'";
			...
			if ($result1->num_rows > 0){
				echo "<table  class=table   style=width:100%><thead><tr><td><center><strong>Topic</strong></center></td><td><center><strong>LastDate</strong></center></td><td><center><strong>CreateDate</strong></center></td></tr><thead>";
				//echo "<hr>";
