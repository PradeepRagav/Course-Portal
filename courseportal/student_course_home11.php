...
<button type="button" class="btn btn-default"  class="btn btn-link" ><a href="/assignment_submission.php/">Submit Assignments </a></button>
 <br><br>
 <button type="button" class="btn btn-default"  class="btn btn-link" ><a href="/ResourceDownload.php/">Download course resource </a></button>
